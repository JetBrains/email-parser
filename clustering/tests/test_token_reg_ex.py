...
class TokenRegExTests(unittest.TestCase):
    ...
    def test_year_token(self):
        tkn = Token("2016,")
        self.assertEqual(token_type["YEAR"], tkn.type_tuple[1])

    def test_email_token(self):
        tkn = Token("<mdfg.dfgg@cvbvc.com>")
        self.assertEqual(token_type["EMAIL"], tkn.type_tuple[1])

    def test_undefined_token(self):
        tkn = Token("@ppzhuk")
        self.assertEqual(token_type["UNDEFINED"], tkn.type_tuple[1])
    ...
    def test_time_token(self):
        tkn = Token("23:59")
        self.assertEqual(token_type["TIME"], tkn.type_tuple[1])
    ...
    def test_date_token(self):
        ...
        self.assertEqual(token_type["DATE_SHORT"], tkn.type_tuple[1])
